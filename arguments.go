...
type arguments struct {
	RawCaseNames string `short:"c" long:"cases" description:"Comma-separated names of enabled cases (options: bare, camel, upper-camel, kebab, upper-kebab, snake, upper-snake, space, upper-space)"`
